...
class Color():
    def __init__(self, imgsize=256, batchsize=4):
        ...
        #Modift CryingMISO
        with tf.variable_scope(tf.get_variable_scope(), reuse=False) as scope_be:
            self.disc_true, disc_true_logits, reuse = self.discriminator(self.real_AB, reuse=False)
            self.disc_fake, disc_fake_logits, reuse = self.discriminator(self.fake_AB, reuse=True)
    ...
    def discriminator(self, image, y=None, reuse=False):
        ...
        return tf.nn.sigmoid(h4), h4, reuse
